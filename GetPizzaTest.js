//Testing GET for http://localhost:5003/gateway/pizza
...
pm.test("Test if object contains property", function () {
    ...
    pm.expect(jsonData).to.contain("name");
    pm.expect(jsonData).to.contain("ingredients");
    pm.expect(jsonData).to.contain("price");
});
